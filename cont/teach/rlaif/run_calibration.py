...
from trainfer.objectives.unlike import unlike_loss, _prefix_ids, _pad_prefixes
from trainfer.objectives.safety import safety_monitor_loss
...
def main():
    calibration_corpus = load_jsonl("cont/teach/rlaif/calibration_corpus.jsonl")
    neutral_corpus = load_jsonl("cont/teach/rlaif/neutral_corpus.jsonl")
    ...
    # Dump results
    with open("docs/research/unlike-defaults-calibration.md", "w") as f:
