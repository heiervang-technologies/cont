...
CLI
---
    python -m cont.teach.research_fixtures.collision_facts --n-pairs 20 --seed 42
"""
...
def write_collision_fixture(
    ...
    Default path: ``data/research/fixtures/collision_facts_<n>_s<seed>.jsonl``
    """
    ...
    if out_path is None:
        try:
            ...
            repo_root = Path.cwd()
        out_dir = repo_root / "data" / "research" / "fixtures"
