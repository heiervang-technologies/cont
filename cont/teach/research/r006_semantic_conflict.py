...
Usage::
    ...
    python -m cont.teach.research.r006_semantic_conflict \
        --endpoint http://127.0.0.1:8768 \
        --n-pairs 20 \
        --seed 42 \
        --baseline-name R006_baseline \
        --out data/research/R006/results.jsonl
    ...
    python -m cont.teach.research.r006_semantic_conflict \
        ...
        --out data/research/R006_smoke/results.jsonl
...
Prerequisites
-------------
- A running trainfer daemon with ``/v1/eval/greedy_rank`` (PR #6) and
  ``/v1/train/memorize``.
...
def run_experiment(
    ...
    out_path: str = "data/research/R006/results.jsonl",
    ...
    """
    from cont.teach.research_fixtures.collision_facts import generate_collision_pairs
...
def main() -> None:
    ...
    parser.add_argument("--out", default="data/research/R006/results.jsonl")
    parser.add_argument(
