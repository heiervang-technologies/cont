...
Usage::
    ...
    python -m cont.teach.research.r001_memorize_retention \
        --endpoint http://127.0.0.1:8768 \
        --n-facts 100 \
        --seed 42 \
        --baseline-name R001_baseline \
        --out data/research/R001/results.jsonl
    ...
    python -m cont.teach.research.r001_memorize_retention \
        ...
        --out data/research/R001b/results.jsonl \
    ...
    python -m cont.teach.research.r001_memorize_retention \
        ...
        --out data/research/R001b_thresh07/results.jsonl \
        --threshold 0.7
...
def run_experiment(
    ...
    out_path: str = "data/research/R001/results.jsonl",
...
def main() -> None:
    ...
    parser.add_argument("--out", default="data/research/R001/results.jsonl")
