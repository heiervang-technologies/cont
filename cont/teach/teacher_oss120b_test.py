"""Unit tests for ``cont.teach.teacher_oss120b.judge``.
...
``cont/tests/test_eval_harness.py`` — torchless and clean.

Run:
    pytest cont/teach/teacher_oss120b_test.py -q
"""
...
from cont.teach import teacher_oss120b
from cont.teach.teacher_oss120b import JudgeResult, judge
