"""Composition + validator tests for cont/teach/replay_streams/.
...
Run: python -m trainfer.tests.test_replay_streams
"""
...
from cont.teach.replay_streams.build_mixed_500 import (
    COMPOSITION,
    Composition,
    SOURCE_OFFSET,
    build_records,
...
from cont.teach.replay_streams.validate import validate
...
def test_cold_generate_is_explicitly_unimplemented():
    ...
    knows where to look."""
    from cont.teach.replay_streams.build_mixed_500 import cold_generate
