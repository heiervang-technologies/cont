...
- [x] Review technical debt (fixed 37 dead code errors with ruff, plus Pydantic deprecation warnings in `lile/server.py`)
- [x] Run mypy and fix any obvious type errors in `lile/` (Skipped: timed out/stuck, possibly env issue, but Pydantic warnings resolved instead)
