...
Single PR to `trainfer/objectives/kl.py` + new test file. No route changes, no schema migration (existing callers unaffected; new branch is opt-in via scope string).
